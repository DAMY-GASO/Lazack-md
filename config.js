...
module.exports = {
  ...
  AUDIO_DATA: process.env.AUDIO_DATA || '𝙇𝘼𝙕𝘼𝘾𝙆-𝙈𝘿;𝙇𝘼𝙕𝘼𝘾𝙆;https://i.imgur.com/ep3UbBP.jpg',
  ...
  STICKER_PACKNAME: process.env.STICKER_PACKNAME || 'LAZACKA;KING',
  ...
  MEDIA_DATA: process.env.MEDIA_DATA|| '𝙇𝘼𝙕𝘼𝘾𝙆;𝙇𝘼𝙕𝘼𝘾𝙆-𝙈𝘿;https://i.imgur.com/ltPPMTh.jpeg',
  SUDO: process.env.SUDO || '255734980103',
  HEROKU_APP_NAME: process.env.HEROKU_APP_NAME || '',
  HEROKU_API_KEY: process.env.HEROKU_API_KEY || '',
  BOT_INFO: process.env.BOT_INFO || '𝙇𝘼𝙕𝘼𝘾𝙆;𝙇𝘼𝙕𝘼𝘾𝙆-𝙈𝘿;https://i.imgur.com/VIpl3q5.mp4',
